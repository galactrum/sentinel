...
def test_proposal_is_valid(proposal):
    ...
    proposal.url = 'http://voting.galactrum.org/dean-miller 5493'
    assert proposal.is_valid() is False

    proposal.url = 'http://voting.galactrumisé.org/dean-miller-5493'
    assert proposal.is_valid() is True

    proposal.url = 'http://voting.galactrumisé.org/dean-миллер-5493'
    assert proposal.is_valid() is True
