...
class Proposal(GovernanceClass, BaseModel):
    ...
    govobj_type = GALACTRUMD_GOVOBJ_TYPES['proposal']
    ...
    def is_valid(self):
        ...
        try:
            ...
            # Galactrum Core restricts proposals to 512 bytes max
...
class Superblock(BaseModel, GovernanceClass):
    ...
    govobj_type = GALACTRUMD_GOVOBJ_TYPES['superblock']
